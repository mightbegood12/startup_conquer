...
document.getElementById('signUpForm').addEventListener('submit', function (event) {
    ...
    if (localStorage.getItem(emailId)) {
        ...
        localStorage.setItem(emailId, JSON.stringify({ username: username, emailId: emailId, password: password }));
...
document.getElementById('loginInForm').addEventListener('submit', function (event) {
    event.preventDefault();
